...
const projects = [
  ...
  {
    title: "Compact Sliding CV",
    description: "A one-card CV with sliding sections: Profile, Skills, and More.",
    icon: "fa-file",
    link: "projects/slide-cv/index.html"
  },
  {
  ...
  },
  {
    ...
    description: "A responsive grid of service cards with icons and titles.",
    icon: "fa-list-check",
    link: "projects/services-grid/index.html"
  },
  {
    title: "FAQ Accordion",
